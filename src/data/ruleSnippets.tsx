...
export const toroidalRulesApply: Translatable = {
    ...
    [LanguageCode.de]: "Das Rätselgitter ist ein Torus-Gitter: Die Oberseite ist mit der Unterseite verbunden, die Linke ist mit der Rechten verbunden",
};
...
export const normalYinYangRulesExplained: Translatable = {
    ...
    [LanguageCode.de]: "Schattieren Sie einige Zellen im Raster, sodass alle schattierten Zellen verbunden und alle nicht schattierten Zellen verbunden sind. Keine 2x2-Box darf vollständig beschattet oder vollständig unverschattet sein",
};
...
export const moveButtonTip: Translatable = {
    ...
    [LanguageCode.de]: "Verwenden Sie die Schaltfläche \"Verschieben\" oder die Pfeiltasten, um das Raster zu verschieben",
};
...
export const antiBishopFromCenterRulesExplained: Translatable = {
    ...
    [LanguageCode.de]: "Zellen, die ein Läufer von der Mittelzelle einer Box aus bewegt, dürfen die Ziffer dieser Mittelzelle nicht enthalten",
};
...
export const loopRulesApply: Translatable = {
    ...
    [LanguageCode.de]: "Zeichnen Sie eine sich nicht überschneidende Schleife durch die Mittelpunkte einiger leerer Zellen",
};
...
export const noBifurcation: Translatable<ReactNode> = {
    ...
    [LanguageCode.de]: <>Und die wichtigste Regel: <strong>Versuchen Sie, die Bifurkation so selten wie möglich einzusetzen</strong> ;)</>,
};
