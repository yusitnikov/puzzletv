...
export const MatchPointPlayer = observer(function MatchPointPlayer({ host, gameId }: MatchPointPlayerProps) {
    ...
    const hostInfo: MatchPointHostInfo | undefined = hostInfoMessages.find(
        (message) => message.clientId === host,
    )?.data;
    ...
    return (
        <div>
            ...
            {state === MatchPointGameState.Answer && (
                <div>
                    <Paragraph>
                    ...
                    <Paragraph>
                        ...
                        {submittedAnswers && (
                            <LargeButton onClick={() => setSubmittedAnswers(undefined)} style={{ marginLeft: "0.5em" }}>
                                {translate({
            ...
            {state === MatchPointGameState.Match && (
                <div>
