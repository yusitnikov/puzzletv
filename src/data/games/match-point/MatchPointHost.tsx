...
export const MatchPointHost = observer(function MatchPointHost() {
    ...
    switch (controller.state) {
        case MatchPointGameState.HomePage: return <MatchPointHostHomePage controller={controller}/>;
        case MatchPointGameState.Setting: return <MatchPointHostSetting controller={controller}/>;
