    ...
    rules: (translate, context) => (
        <>
            ...
            <RulesParagraph>
                {translate({
                    [LanguageCode.en]:
                        "Cages don't intersect with other cages, but they can intersect with other arrows",
                    [LanguageCode.ru]:
                        "Клетки не пересекаются с другими клетками, но они могут пересекаться с другими стрелками",
                    [LanguageCode.de]:
                        "Käfige überschneiden sich nicht mit anderen Käfigen, sie können sich jedoch mit anderen Pfeilen überschneiden",
                })}
                .
            </RulesParagraph>
            <RulesParagraph>
                ...
                {translate({
                    [LanguageCode.en]:
                        "There are two initial light sources that illuminate the darkness and clear the fog",
                    [LanguageCode.ru]:
                        "Есть два изначальных источника света, которые освещают темноту и рассеивают туман",
                    [LanguageCode.de]:
                        "Es gibt zunächst zwei Lichtquellen, die die Dunkelheit erhellen und den Nebel vertreiben",
                })}
                .{" "}
                {translate({
                    [LanguageCode.en]:
                        "Put correct digits into the cells to get more light (it's ok to put a digit into a cell that is covered by fog)",
                    [LanguageCode.ru]:
                        "Поместите правильные цифры в ячейки, чтобы получить больше света (можно поместить цифру в ячейку, покрытую туманом)",
                    [LanguageCode.de]:
                        "Geben Sie die richtigen Ziffern in die Zellen ein, um mehr Licht zu erhalten (es ist in Ordnung, eine Ziffer in eine Zelle einzutragen, die von Nebel bedeckt ist)",
                })}
                .
            </RulesParagraph>
