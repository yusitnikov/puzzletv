...
export const MeteorShower = (colorful: boolean): PuzzleDefinition<NumberPTM> => ({
    ...
    items: [
        ThermometerConstraint(["R7C7", "R1C1"], true, false, colorful ? "#edff63" : undefined),
        ThermometerConstraint(["R2C4", "R5C7"], true, false, colorful ? "#4f8e99" : undefined),
        ThermometerConstraint(["R4C-1", "R7C2"], true, false, colorful ? "#ff403d" : undefined),
        ThermometerConstraint(["R4C1", "R2C-1"], true, false, colorful ? "#87c8cf" : undefined),
        ThermometerConstraint(["R-1C3", "R1C5"], true, false, colorful ? "#a9c731" : undefined),
        ThermometerConstraint(["R-1C-2", "R2C1"], true, false, colorful ? "#3facbb" : undefined),
        ThermometerConstraint(["R-2C-1", "R1C2"], true, false, colorful ? "#b9cf99" : undefined),
    ],
