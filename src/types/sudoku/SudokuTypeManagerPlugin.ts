...
// region Field state
export type ReplaceFieldStateEx<T extends AnyPTM, FieldStateEx> = Omit<T, "fieldStateEx"> & {fieldStateEx: FieldStateEx};
...
export const addFieldStateExToSudokuManager = <T extends AnyPTM, FieldStateEx>(
    ...
    function splitFieldStateEx(value: Partial<T2["fieldStateEx"]>, useDefaults = false): {base: Partial<T["fieldStateEx"]>, ex: Partial<FieldStateEx>} {
...
// region Game state
export type ReplaceGameStateEx<T extends AnyPTM, GameStateEx, ProcessedGameStateEx> = Omit<T, "stateEx" | "processedStateEx"> & {stateEx: GameStateEx, processedStateEx: ProcessedGameStateEx};
export type AddGameStateEx<T extends AnyPTM, GameStateEx, ProcessedGameStateEx> = ReplaceGameStateEx<T, T["stateEx"] & GameStateEx, T["processedStateEx"] & ProcessedGameStateEx>;
...
export const addGameStateExToSudokuManager = <T extends AnyPTM, GameStateEx, ProcessedGameStateEx>(
    ...
    }: {initialGameStateExtension: GameStateEx | ((puzzle?: PuzzleDefinition<ReplaceGameStateEx<T, GameStateEx, ProcessedGameStateEx>>) => GameStateEx)} & Partial<Pick<
        SudokuTypeManager<ReplaceGameStateEx<T, GameStateEx, ProcessedGameStateEx>>,
        "serializeGameState" | "unserializeGameState" | "useProcessedGameStateExtension" | "getProcessedGameStateExtension"
    >>,
    ...
    const simpleInitialGameStateExtension2 = typeof initialGameStateExtension2 === "function"
        ? (initialGameStateExtension2 as (() => GameStateEx))()
        : initialGameStateExtension2 as GameStateEx;

    function splitGameStateEx(value: T2["stateEx"]): {base: T["stateEx"], ex: GameStateEx};
    function splitGameStateEx(value: Partial<T2["stateEx"]>, useDefaults?: boolean): {base: Partial<T["stateEx"]>, ex: Partial<GameStateEx>};
    function splitGameStateEx(value: Partial<T2["stateEx"]>, useDefaults = false): {base: Partial<T["stateEx"]>, ex: Partial<GameStateEx>} {
    ...
    return ({
            ...
            return {
                ...(
                    typeof initialGameStateExtension === "function"
                        ? (initialGameStateExtension as ((puzzle: PuzzleDefinition<T>) => T["stateEx"]))(puzzle as unknown as PuzzleDefinition<T>)
                        : initialGameStateExtension as T["stateEx"]
                ),
                ...(
                    typeof initialGameStateExtension2 === "function"
                        ? (initialGameStateExtension2 as ((puzzle: PuzzleDefinition<ExT>) => GameStateEx))(puzzle as unknown as PuzzleDefinition<ExT>)
                        : initialGameStateExtension2 as GameStateEx
                ),
            };
        },
        ...
        useProcessedGameStateExtension(context: PuzzleContext<T2>): T2["processedStateEx"] {
            return {
                ...
                // eslint-disable-next-line react-hooks/rules-of-hooks
                ...useProcessedGameStateExtension2?.(context as unknown as PuzzleContext<ExT>) as ProcessedGameStateEx,
            };
        },
        ...
        getProcessedGameStateExtension(context: PuzzleContext<T2>): T2["processedStateEx"] {
            return {
                ...
                ...getProcessedGameStateExtension2?.(context as unknown as PuzzleContext<ExT>) as ProcessedGameStateEx,
            };
        },
    });
};
