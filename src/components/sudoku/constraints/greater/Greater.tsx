...
export const Greater: ConstraintPropsGenericFcMap = {
    [GridLayer.afterLines]: observer(function Greater<T extends AnyPTM>({
        ...
        return (
            ...
            >
                <line x1={radius} y1={0} x2={-radius} y2={radius} strokeWidth={lineWidth} stroke={blackColor} />
...
export const GreaterConstraint = <T extends AnyPTM>(
    greaterCellLiteral: PositionLiteral,
    lessCellLiteral: PositionLiteral,
): Constraint<T> => {
    return {
        name: "inequality",
