                ...
                {digits.map((digit, index) => {
                    ...
                    return (
                        <AutoSvg
                            ...
                            angle={-angle}
                        >
                            <circle r={digitRadius} strokeWidth={0} stroke={"none"} fill={"#fff"} />
                            <CenteredText size={digitRadius * 1.75} fill={textColor}>
                                {digit}
                            </CenteredText>
                        </AutoSvg>
                    );
...
export const WheelConstraint = <T extends AnyPTM>(
    ...
    return {
        ...
        component: Wheel,
        isObvious: true,
        isValidCell(cell, digits, cells, context, constraints, constraint, isFinalCheck): boolean {
            ...
            const actualDigit = context.puzzle.typeManager.getDigitByCellData(
                digits[cell.top][cell.left]!,
                context,
                cell,
            );
...
export const createWheel = (cell: PositionLiteral, ...digits: (number | undefined)[]) =>
    createRotatableClue(cell, 0, undefined, [WheelConstraint(cell, digits)]);
