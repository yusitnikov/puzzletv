...
export const MultiPlayerInfo = observer(function MultiPlayerInfo<T extends AnyPTM>({context}: MultiPlayerInfoProps<T>) {
    profiler.trace();
    ...
    return <div style={{fontSize: cellSize * h2HeightCoeff}}>
