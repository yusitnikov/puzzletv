...
export const multiPlayerTurnsRules: Translatable = {
    ...
    [LanguageCode.de]: "Die Spieler legen abwechselnd zuerst ein Quad auf das Gitter und geben dann eine Ziffer in ein Feld ein",
};
...
export const placeQuadRules: Translatable = {
    ...
    [LanguageCode.de]: "Platzieren Sie einen Quad-Hinweis an einer beliebigen Stelle im Raster an einem Schnittpunkt zwischen 4 Zellen und geben Sie 4 Ziffern ein",
};
...
export const quadYellowDigits: Translatable = {
    ...
    [LanguageCode.de]: "Ziffern auf gelbem Hintergrund müssen sich innerhalb der 4 Zellen befinden, jedoch nicht an der gleichen exakten Position",
};
...
export const incorrectGuessMultiPlayerRules: Translatable = {
    ...
    [LanguageCode.de]: "Wenn Sie falsch geraten haben, ist Ihr Zug beendet und der nächste Spieler beginnt mit dem Platzieren eines Quaders",
};
...
export const incorrectGuessSinglePlayerRules: Translatable = {
    ...
    [LanguageCode.de]: "Mit einer falschen Vermutung endet die Runde und Sie beginnen erneut mit Phase 1 (Platzieren eines Quads).",
};
...
export const singlePlayerScoreRules: Translatable = {
    ...
    [LanguageCode.de]: "Für jedes falsche Erraten einer Ziffer wird 1 Punkt zu Ihrer Punktzahl addiert. Versuchen Sie, die niedrigstmögliche Punktzahl zu erreichen",
};
...
export const privatePencilmarksNote: Translatable<ReactNode> = {
    ...
    [LanguageCode.de]: <>Hinweis: Sie können das Raster mit einem Bleistift markieren, um Notizen zu machen.<br/>Ihre Gegner sehen nur die tatsächlichen Vermutungen</>,
};
