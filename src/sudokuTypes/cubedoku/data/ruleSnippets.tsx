...
export const cubedokuIndexingRules: Translatable = {
    ...
    [LanguageCode.de]: "Jede Ziffer in jedem Raster indiziert eine 1x1x1-Zielzelle innerhalb des Würfels, und jede Zielzelle muss von allen drei Rastern indiziert werden",
};
...
export const cubedokuIndexingDetails: Translatable = {
    ...
    [LanguageCode.de]: "Die Ziffer 1 in einer Zelle gibt an, dass die Zielzelle der 1x1x1-Würfel ist, der der Oberfläche des Würfels, auf dem sich die Ziffer befindet, am nächsten liegt, während eine Ziffer 2 in einer Zelle angibt, dass die Zielzelle der zweite Würfel unterhalb der Oberfläche ist, und bald",
};
