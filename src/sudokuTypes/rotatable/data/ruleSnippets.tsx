...
export const rotatableSudokuRules: Translatable<ReactNode> = {
    ...
    [LanguageCode.de]: <><strong>Das Sudoku-Feld kann im Uhrzeigersinn gedreht werden.</strong> Es liegt an Ihnen, die korrekte Ausrichtung des Rätsels zu bestimmen.</>,
};
