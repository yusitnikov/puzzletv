...
export const RotatableDigitSudokuTypeManager = ({
    stickyDigits = false,
}: Partial<PuzzleImportOptions> = {}): SudokuTypeManager<RotatableDigitPTM> =>
    RotatableDigitSudokuTypeManagerBase<RotatableDigitPTM>(
        {
