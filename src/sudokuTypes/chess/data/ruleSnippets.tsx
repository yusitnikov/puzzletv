...
export const chessSudokuRules: Translatable<ReactNode> = {
    ...
    [LanguageCode.de]: <>
        <strong>Es gelten die normalen Schach-Regeln</strong>:
        Platziere zusätzliche Figuren um Positionen zu erreichen,
        die auch in einem normalen Schachspiel vorkommen könnten
    </>,
};
...
export const optionalChessPiecesRules: Translatable = {
    ...
    [LanguageCode.de]: "Es ist nicht zwingend erforderlich, alle möglichen Schachfiguren zu verwenden (wenn das Platzieren einer Figur keinen Einfluss auf die Richtigkeit des Puzzles hat, platzieren Sie sie nicht)",
};
...
export const normalSudokuRulesForChessPieces: Translatable = {
    ...
    [LanguageCode.de]: "Schachfiguren dürfen sich in der gleichen Zeile, Spalte oder umrandeter Region nicht wiederholen",
};
...
export const emptyCells: Translatable = {
    ...
    [LanguageCode.de]: "Im Gegensatz zu Sudoku muss aber nicht jedes Feld besetzt sein (es gibt also Felder, die frei bleiben)",
};
...
export const mateInOne: Translatable = {
    ...
    [LanguageCode.de]: "Gesucht wird eine Stellung, in der sowohl Weiß als auch Schwarz mit nur einem Zug das Spiel durch ein Matt gewinnen können (Matt in einem Zug)",
};
