...
export interface ChessPieceProps extends Partial<Position> {
    type: ChessPieceType;
...
export const ChessPiece = observer(function ChessPiece({type, pieceColor, fontColor = textColor, size = 1, top = 0, left = 0}: ChessPieceProps) {
    profiler.trace();
