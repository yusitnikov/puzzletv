...
export const TransformScaleContextProvider = observer(function TransformScaleContextProviderFc({scale, children}: PropsWithChildren<{scale: number}>) {
    profiler.trace();
...
export const TransformedRectGraphics = observer(function TransformedRectGraphics({rect, children}: PropsWithChildren<{rect: TransformedRect}>) {
    profiler.trace();
